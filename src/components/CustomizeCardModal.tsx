        ...
        <div style={{
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px" }}>
              <span style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "17px", fontWeight: 600, color: "var(--text-primary)" }}>
              ...
              <button onClick={() => setOpen(false)}
                ...
                onMouseEnter={(e) => { e.currentTarget.style.background = "var(--bg-badge)"; e.currentTarget.style.color = "var(--text-primary)"; }}
            ...
            {saved && (
              <div style={{ textAlign: "center", marginTop: "6px", fontSize: "13px", color: "var(--text-success, #4ade80)", fontWeight: 500 }}>
                Size saved!
              </div>
            )}
